...
# Train a document model with specified # of topics. This will run Mallet over 
# the documents from data.dir and store the results along with some supporting  
# information in a convenient data structure
